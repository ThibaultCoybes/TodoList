...
return [
    ...
    'app_todo_index' => [[], ['_controller' => 'App\\Controller\\TodoController::index'], [], [['text', '/todo/']], [], [], []],
    'app_todo_new' => [[], ['_controller' => 'App\\Controller\\TodoController::new'], [], [['text', '/todo/new']], [], [], []],
    'app_todo_show' => [['id'], ['_controller' => 'App\\Controller\\TodoController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/todo']], [], [], []],
    'app_todo_edit' => [['id'], ['_controller' => 'App\\Controller\\TodoController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/todo']], [], [], []],
    'app_todo_delete' => [['id'], ['_controller' => 'App\\Controller\\TodoController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/todo']], [], [], []],
